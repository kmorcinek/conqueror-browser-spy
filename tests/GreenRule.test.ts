...
describe("GreenRuleTest", () => {
  ...
  it("one even card", () => {
    ...
    const opponentPalette: Card[] = [CardFactory.byRank(7), CardFactory.byRank(5)];
  ...
  it("more even cards", () => {
    ...
    const opponentPalette: Card[] = [CardFactory.byRank(6)];
  ...
  it("higher color", () => {
    ...
    const opponentPalette: Card[] = [CardFactory.of(4, Color.Yellow)];
