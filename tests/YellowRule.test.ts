...
describe("YellowRuleTest", () => {
  ...
  it("more cards with rank yellow color", () => {
    ...
    const opponentPalette: Card[] = [CardFactory.of(3, Color.Yellow), CardFactory.of(5, Color.Red)];
  ...
  it("when two colors have the same count, then the highest card wins", () => {
    ...
    const opponentPalette: Card[] = [CardFactory.of(5, Color.Orange), CardFactory.of(5, Color.Red)];
